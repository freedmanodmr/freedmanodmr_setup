...
""" 
NOTE: If you plan to use the lock-in amplifier for your detection using the APD, 
you can comment out the TimeTagger so that you can monitor the data on their software
"""
