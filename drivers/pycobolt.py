...
class CoboltLaser:
    ...
    def turn_on(self):
        """Turn on the laser with the autostart sequence.
        The laser will await the TEC setpoints and 
        pass a warm-up state"""
        logger.info("Turning on laser")
        return self.send_cmd(f"l1")
...
class Cobolt06(CoboltLaser):
    ...
    def power_modulation_mode(self, digital_enabled:bool=True,analog_enabled:bool=False ):
        '''06-MLD: Use power modulation for digital modulation up to 10 MHz 
        and/or analog modulation up to 10 Hz
        06-DPL: Use power modulation for digital modulation up to 1 kHz 
        and/or analog modulation up to 1kHz '''
    ...
    def current_modulation_mode(self, digital_enabled:bool=True,analog_enabled:bool=False ):
        '''06-MLD: Use power modulation for digital modulation above 10 MHz 
        and/or analog modulation above 10 Hz
        06-DPL: Use power modulation for digital modulation above 1 kHz 
        and/or analog modulation above 1kHz '''
